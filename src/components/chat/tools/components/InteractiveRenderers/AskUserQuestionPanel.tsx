...
export const AskUserQuestionPanel: React.FC<PermissionPanelProps> = ({
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-lg border border-gray-200/80 bg-white shadow-lg dark:border-gray-700/50 dark:bg-gray-800/90 dark:shadow-2xl">
        {/* Accent line */}
