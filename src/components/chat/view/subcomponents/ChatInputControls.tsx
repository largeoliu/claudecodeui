...
export default function ChatInputControls({
  ...
  return (
    <div className="no-scrollbar flex w-full flex-nowrap items-center overflow-x-auto py-0.5 scroll-smooth">
      ...
      {(provider === 'codex' && codexInteractionMode && onInteractionModeChange || provider === 'codex' && approvalPolicy && onApprovalPolicyChange) && (
        <div className="flex items-center gap-2 flex-shrink-0 ml-2 md:ml-auto">
